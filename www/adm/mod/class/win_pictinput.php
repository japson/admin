	...
	public function massPictur($kodrasdel){
		...
		$mass_pict='<div class="divtblpict" ><p></p><table id="'.$this->alias.'" class="table"><tbody>';
			foreach($stmt->fetchAll(PDO::FETCH_ASSOC) as $row){
				$tr_up.='<td id='.$row["kod"].'><a href="'.$this->putimg.$row["name"].'" class="photo img-thumbnail" data-fancybox="group" title="'.$row["note"].'"><img src="'.$this->putimg.$row["name_small"].'?'.rand().'"  >	</a></td>';
				$tr_down.='<td id='.$row["kod"].'> <i id="pict_pencil" class="glyphicon glyphicon-pencil" title="Редактировать название"></i><i id="pict_left" class="glyphicon glyphicon-arrow-left" title="Переместить влево"></i><i id="pict_right" class="glyphicon glyphicon-arrow-right" title="Переместить вправо"></i><i id="pict_preview" class="glyphicon glyphicon-picture" title="Изменить превью"></i>
<i id="pict_del" class="glyphicon glyphicon-remove" title="Удалить"></i></td>';
			}
